...
# Aim: launch a functional test for eqtlbma_bf with covariates
...
function help () {
    msg="\`${0##*/}' launches a functional test for eqtlbma_bf with covariates.\n"
    msg+="\n"
    msg+="Usage: ${0##*/} [OPTIONS] ...\n"
    msg+="\n"
    msg+="Options:\n"
...
function simul_data_and_calc_exp_res () {
    ...
    ${pathToRscript} --verbose 1 --dir $(pwd) --cvrt >& stdout_simul_exp
}
