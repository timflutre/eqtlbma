...
#      in some subgroups and individuals
...
function help () {
    msg="\`${0##*/}' launches a functional test for eqtlbma_bf with genes absent in some subgroups and individuals.\n"
    msg+="\n"
    msg+="Usage: ${0##*/} [OPTIONS] ...\n"
    msg+="\n"
    msg+="Options:\n"
...
function simul_data_and_calc_exp_res () {
    ...
    ${pathToRscript} --verbose 1 --dir $(pwd) --rgsi >& stdout_simul_exp
}
