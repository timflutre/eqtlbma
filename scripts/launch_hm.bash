...
# Aim: launch the hierarchical model from output files of 'eqtlbma-bf'
# Author: Timothee Flutre
# Not copyrighted -- provided to the public domain

function help () {
    msg="\`${0##*/}' launches the hierarchical model from output files of eqtlbma-bf.\n"
    msg+="\n"
    msg+="Usage: ${0##*/} [OPTIONS] ...\n"
    msg+="\n"
    msg+="Options:\n"
    ...
    msg+="\t\tusually 'X_l10abfs_raw.txt.gz' files generated by 'eqtlbma-bf'\n"
...
function parseArgs () {
    TEMP=`getopt -o hVv: -l help,version,verbose:,p2b:,inp:,inf:,nbC:,nbG:,outp:,reconf:,skip-ci,pi0:,keepin \
	-n "$0" -- "$@"`
